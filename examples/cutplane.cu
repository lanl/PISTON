...
marching_cube<plane_field<int, float, SPACE>, vtk_image3d<int, float, SPACE> > *isosurface_p;
...
int main(int argc, char *argv[])
{
    ...
    plane_field<int, float, SPACE> plane(make_float3(0.0f, 0.0f, 0.0f),
                                         make_float3(0.0f, 0.0f, 1.0f),
                                         vtk_image->GetDimensions()[0],
                                         vtk_image->GetDimensions()[1],
                                         vtk_image->GetDimensions()[2]);

    marching_cube<plane_field<int, float, SPACE>, vtk_image3d<int, float, SPACE> > isosurface(plane, image, 0.0f);
